...
const Logo_Instagram = ({ size = 32 }) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 36 36" fill="none" onClick={() => window.location='https://www.instagram.com/centralesupelec_league/'}>
