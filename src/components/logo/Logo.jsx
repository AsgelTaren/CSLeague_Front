...
const Logo_Instagram = ({ size = 32 }) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 36 36" fill="none">
            <path d="M24.7429 2H11.2571C6.14456 2 2 5.97319 2 10.8744V25.1256C2 30.0268 6.14456 34 11.2571 34H24.7429C29.8554 34 34 30.0268 34 25.1256V10.8744C34 5.97319 29.8554 2 24.7429 2Z" stroke="#802626" stroke-width="2.4888" stroke-linecap="round" />
            <path d="M18.0021 25.8166C22.5078 25.8166 26.1604 22.3151 26.1604 17.9957C26.1604 13.6763 22.5078 10.1748 18.0021 10.1748C13.4964 10.1748 9.84387 13.6763 9.84387 17.9957C9.84387 22.3151 13.4964 25.8166 18.0021 25.8166Z" stroke="#802626" stroke-width="2.4888" stroke-linecap="round" />
            <path d="M27.7692 8.7757C28.4101 8.7757 28.9296 8.27763 28.9296 7.66324C28.9296 7.04885 28.4101 6.55078 27.7692 6.55078C27.1283 6.55078 26.6088 7.04885 26.6088 7.66324C26.6088 8.27763 27.1283 8.7757 27.7692 8.7757Z" stroke="#802626" stroke-width="2.4888" />
        </svg>
    );
};
